...
//    Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scannedTV.setTextIsSelectable(true);
//        btn.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                String linkeddata = null;
//                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(linkeddata));
...
//        });
        ...
        camera.setScannerViewEventListener(new ScannerLiveView.ScannerViewEventListener() {
            ...
            public void onScannerStarted(ScannerLiveView scanner) {
                ...
                Toast.makeText(Attendance.this, "Scanner Started", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onScannerStopped(ScannerLiveView scanner) {
                // method is called when scanner is stopped.
                Toast.makeText(Attendance.this, "Scanner Stopped", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onScannerError(Throwable err) {
                // method is called when scanner gives some error.
                Toast.makeText(Attendance.this, "Scanner Error: " + err.getMessage(), Toast.LENGTH_SHORT).show();
            }
